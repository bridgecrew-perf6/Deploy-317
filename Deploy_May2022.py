...
MM = pd.read_csv("MM_Dummies10.csv")
...
#Treemap with countries
   dbc.Row([dbc.Col(html.H3("Dead and Missing Migrants by Country",
                           style ={"text-align": "center"}),
                         xs = 12, sm = 12, md = 12, lg = 12, xl = 12),
           ], 
            justify = 'center',
...
#Download button
    dbc.Row([html.Button("Download Selected Data", id="btn_dta"),
              dcc.Download(id="download_csv")], 
              justify = 'center'),
    
    dbc.Row([dbc.Col(html.Br())]), 
    
    dbc.Row([dbc.Col(html.Div("Once you have clicked this button, please hit refresh before doing a new search.",
                              style ={"text-align": "center", "color": '#808080'}),
                     xs = 4, sm = 4, md = 4, lg = 4, xl = 4),
            ], 
            justify = 'center',
    ...
    dbc.Row([dbc.Col(html.H2("Custom Forecasting (Coming April, 2022)",
                             className = 'text-primary, mb-4',
                             style ={'color': '#0099C6', "text-align": "center",
                                     "font-weight": "bold"}),
                     xs = 12, sm = 12, md = 12, lg = 12, xl = 12
