...
MM = pd.read_csv("MM_dummies7.csv")
...
new_col = ['Incident_ID', 'Incident_Type', 'Region', 'Reported_Date',
       ...
       'Region of Origin', 'Migration_Route', 'Location_Description',
       'Info_Source', 'Coordinates', 'UNSD_Geographical_Grouping',
       'Article_Title', 'Source_Quality', 'URL', 'Other Accidents',
